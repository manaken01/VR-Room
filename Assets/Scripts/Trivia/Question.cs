...
public class Question : ScriptableObject {                                     //Clase pregunta y sus contenidos
 
    public enum                 AnswerType                  { Multi, Single } //Solo existen single
    ...
    [SerializeField] private    AnswerType  _answerType     = AnswerType.Multi;     //No se ocupa porque solo hay un tipo
